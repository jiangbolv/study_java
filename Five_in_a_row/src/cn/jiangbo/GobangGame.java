...
public class GobangGame {
	...
	public void start() throws Exception{
		...
		//br.readline:每当键盘输入一行的内容按回车键，则输入的内容就被br读取到
	...
	public boolean isWon(int posX,int posY,String ico){
		...
		int temp = 0;
		//计算起点的最小X坐标与Y坐标
		temp = posX-WON_COUNT+1;
		startX = temp<0? 0:temp;
		temp = posY-WON_COUNT+1;
		...
		return sameCount== WON_COUNT-1?true:false;
